...
export const artists: Artist[] = [
  {
    ...
    body: {
      ko: [
        "2009년부터 일본에서 열리는 한국가요 콘테스트에 나가기 시작했다. 2011년에는 전국대회에 참가했다. 수년간 일본에서 한국어 노래를 부르며 실력을 쌓은 뒤 직접 한국으로 건너왔다.",
      ...
      ja: [
        "2009年から日本で開かれる韓国歌謡コンテストに出場し始めた。2011年には全国大会に参加。数年間、日本で韓国語の歌を歌って実力を積んだのち、自ら韓国へ渡った。",
        "2015年、KBS『全国のど自慢』に出演して才能を認められ、2016年に1集《サランイラムニダ(愛なんです)》で韓国CDデビュー。以後、韓国でTV・ラジオ・イベント・慰問公演を、日本では韓国大使館・日韓親善協会の公演やトロット講師としても活動した。",
    ...
    history: [
      { year: "2009", text: { ko: "한국가요 콘테스트 참가 시작", ja: "韓国歌謡コンテスト参加開始", en: "Began entering Korean-song contests in Japan" } },
