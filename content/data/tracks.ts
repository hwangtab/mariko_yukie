...
export const tracks: Track[] = [
  ...
  },
  {
    ...
    title: { ko: "愛の盃", ja: "愛の盃(日本語ver.)", en: "Cup of Love (Japanese Ver.)" },
  ...
  },
  {
    ...
    title: { ko: "ホットフラッシュ", ja: "ホットフラッシュ(日本語ver.)", en: "Hot Flash (Japanese Ver.)" },
  ...
  },
  {
    ...
    title: { ko: "ビールとコーヒー", ja: "ビールとコーヒー(日本語ver.)", en: "Beer and Coffee (Japanese Ver.)" },
    type: { ko: "04번 트랙 일본어 버전", ja: "4曲目の日本語バージョン", en: "Japanese version of track 4" },
    body: { ko: ["번역이 아닌 재해석."], ja: ["翻訳ではなく再解釈。"], en: ["Reinterpretation, not translation."] },
  },
  {
    number: 14, slug: "namsan-tower-ja", language: "ja",
    title: { ko: "南山タワー", ja: "南山タワー(日本語ver.)", en: "Namsan Tower Lights (Japanese Ver.)" },
  ...
  },
  {
    ...
    title: { ko: "夢で逢った男(ひと)", ja: "夢で逢った男(ひと)", en: "The Person I Saw in a Dream" },
